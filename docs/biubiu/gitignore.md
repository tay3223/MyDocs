...
在项目的`"根目录"`下创建`.gitignore`文件，然后插入以下内容：
```
# =========================================
# git提交时，会忽略.gitignore文件中的文件
# =========================================
...
*.env
```
如果想忽略什么文件，就把对应的`文件名`写进去即可！

[参考文档-传送门](https://github.com/github/gitignore)
...
[参考文档-传送门](https://www.cnblogs.com/kevingrace/p/5690241.html)
